...
const BLOG = {
  AUTHOR: '你不曾同我在雨夜聽搖滾到天亮', // 作者
  BIO: '动情的灵魂终将在前夜告别', // 作者简介
  LINK: 'https://lunatic-eve.vercel.app/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'ec8a0437c27347b3a7bcb34c4ada10b3', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'a62509ea-ce7f-49ba-8a5f-4e77fa30be0c', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
